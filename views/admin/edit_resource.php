...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-card">
            ...
            <form method="POST" enctype="multipart/form-data" id="adminEditResourceForm" novalidate><div class="row"><div class="col-md-8 mb-3"><label class="form-label">Titre *</label><input type="text" name="titre" class="form-control" value="<?= htmlspecialchars($resource['titre']) ?>"></div><div class="col-md-4 mb-3"><label class="form-label">Type *</label><select name="type" class="form-select"><option value="Cours" <?= $resource['type'] == 'Cours' ? 'selected' : '' ?>>Cours</option><option value="Exercice" <?= $resource['type'] == 'Exercice' ? 'selected' : '' ?>>Exercice</option><option value="Examen" <?= $resource['type'] == 'Examen' ? 'selected' : '' ?>>Examen</option><option value="TD" <?= $resource['type'] == 'TD' ? 'selected' : '' ?>>TD</option><option value="TP" <?= $resource['type'] == 'TP' ? 'selected' : '' ?>>TP</option></select></div></div>
            <div class="mb-3"><label class="form-label">Description *</label><textarea name="description" class="form-control" rows="4"><?= htmlspecialchars($resource['description']) ?></textarea></div>
