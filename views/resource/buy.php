...
<body>
    <div class="container"><div class="row justify-content-center"><div class="col-md-6"><div class="form-card"><div class="text-center mb-4"><h2>💳 Paiement sécurisé</h2><p class="text-muted">Déverrouillez l'accès premium</p></div>
        ...
        <form method="POST" id="paymentForm"><div class="mb-3"><input type="text" class="form-control" placeholder="Numéro de carte" required></div><div class="row"><div class="col-md-6 mb-3"><input type="text" class="form-control" placeholder="MM/YY" required></div><div class="col-md-6 mb-3"><input type="text" class="form-control" placeholder="CVV" required></div></div>
        <div class="mb-3"><input type="text" class="form-control" placeholder="Nom du titulaire" required></div>
