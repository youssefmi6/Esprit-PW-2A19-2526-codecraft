...
<div class="container">
    ...
    <div class="row justify-content-center"><div class="col-md-8"><div class="form-card">
        <form method="POST" enctype="multipart/form-data" id="uploadForm" novalidate>
            <div class="mb-3"><label>Titre</label><input type="text" name="titre" id="titre" class="form-control"></div>
            <div class="mb-3"><label>Description</label><textarea name="description" id="description" class="form-control" rows="3"></textarea></div>
            <div class="row"><div class="col-md-6 mb-3"><label>Matière</label><select name="matiere" id="matiere" class="form-select"><option value="">Sélectionner</option><option>Mathématiques</option><option>Physique</option><option>Chimie</option><option>Informatique</option><option>Programmation</option><option>HTML/CSS</option><option>JavaScript</option><option>Python</option><option>Java</option><option>Base de données</option><option>Réseaux</option><option>Économie</option><option>Gestion</option><option>Droit</option><option>Langues</option><option>Anglais</option><option>Français</option><option>Autre</option></select></div>
            ...
            <div class="col-md-6 mb-3"><label>Pages</label><input type="number" name="pages" id="pages" class="form-control"></div></div>
            ...
            <div class="mb-4"><div class="upload-area" onclick="document.getElementById('fileInput').click()"><i class="ti-upload" style="font-size:48px;"></i><p>Fichier PDF</p><input type="file" id="fileInput" name="fichier" style="display:none;" onchange="previewFile(this)"></div><div id="fileName" class="mt-2 text-center text-success"></div></div>
